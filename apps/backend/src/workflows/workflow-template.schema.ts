    ...
    nodes: [
      {
        ...
        description: 'Trigger codebase ingestion',
        nextNodeId: 'n2',
      },
      {
        id: 'n2',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        description: 'Human review of strategy',
        nextNodeId: 'n3',
      },
      {
        id: 'n3',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        agentRole: '',
        requiresHumanApproval: false,
        description: 'Feature merged',
        kanbanStatus: 'done',
        kanbanStatusTrigger: 'on_complete',
      },
    ],
    edges: [
      { from: 'n1', to: 'n2' },
